...
button_go = Button(master=window, text="Go", command=run, borderwidth=0, background="black", foreground="white", activebackground="white", activeforeground="black")
button_go.place(x=10, y=40)
button_help = Button(master=window, text="Country codes list", command=help, borderwidth=0, background="black", foreground="white", activebackground="white", activeforeground="black")
